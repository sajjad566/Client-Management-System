								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<h6><b>DMV :</b> @if($renewal->dmv == "") --- @else <a href="/storage/{{ $renewal->dmv }}" target="_blank">View</a> @endif </h6>
											<h6><b>TLC :</b> @if($renewal->tlc == "") --- @else <a href="/storage/{{ $renewal->tlc }}" target="_blank">View</a> @endif </h6>
											<h6><b>DDC :</b> @if($renewal->ddc == "") --- @else<a href="/storage/{{ $renewal->ddc }}" target="_blank">View</a> @endif </h6>
